...
from the squad-managed selection.`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			return runRemoveFlow(h, cmd, args)
		},
	}
}

// runRemoveFlow executes the core remove logic: read config, remove the agent
// from selected_agents, and save config.
func runRemoveFlow(h *removeHandler, cmd *cobra.Command, args []string) error {
